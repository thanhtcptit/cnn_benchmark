...
def fixed_padding(inputs, kernel_size, data_format):
    ...
    Args:
        ...
        kernel_size: The kernel to be used in the conv2d or max_pool2d op.
...
class Model(object):
    ...
    def __init__(self, resnet_size, bottleneck, num_classes, num_filters,
                 ...
                 resnet_version=DEFAULT_VERSION, data_format='channels_last',
                 dtype=DEFAULT_DTYPE):
        ...
        block_sizes: A list containing n values, where n is the number of sets
            of block layers desired. Each value should be the number of blocks
            in the i-th set.
    ...
    def _custom_dtype_getter(self, getter, name, shape=None,
        ...
        custom getter, instead of directly getting a variable itself.
        This can be used to change the types of variables that are retrieved
        with tf.get_variable. The `getter` parameter is the underlying
        variable getter, that would have been called if no custom getter was
        used. Custom getters typically get a variable with `getter`,
        then modify it in some way.
    ...
    def __call__(self, inputs, training):
        ...
        with self._model_variable_scope():
            ...
            inputs = tf.reduce_mean(input_tensor=inputs, axis=axes,
                                    keepdims=True)
